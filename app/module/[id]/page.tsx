    ...
    return (
      ...
      >
        <div className="text-center max-w-md w-full">
          ...
          <p
            className={`mb-6 text-sm sm:text-base ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}
          >
            {error}
          </p>
          <Link
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <span
                className={`hidden sm:inline ${isDarkMode ? "text-gray-500" : "text-gray-400"}`}
              >
                •
              </span>
              <h1
            ...
            <div className="flex items-center justify-between sm:justify-end space-x-3">
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-3 sm:px-4 py-2 rounded-lg transition-colors duration-200 cursor-pointer text-sm sm:text-base ${
                  isDarkMode
                    ? "bg-white text-black hover:bg-gray-200"
                    : "bg-black text-white hover:bg-gray-800"
                }`}
